...
public class PreguntaActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    public void actualizar()
    {
        ...
        String[] opciones = intento.getStringArrayExtra(OPCIONES);
    ...
    public void onClick(View v)
    {
        ...
        switch (v.getId())
        {
            case R.id.butOpc1:
            {
                resultado.putExtra(RESPUESTA, butOp1.getText().toString());
            ...
            case R.id.butOpc2:
            {
                ...
                resultado.putExtra(RESPUESTA, butOp2.getText().toString());
                setResult(RESULT_OK, resultado);
                //finish();
                textoPregunta.setText("");
                butOp1.setText("");
            ...
            case R.id.butOpc3:
            {
                resultado.putExtra(RESPUESTA, butOp3.getText().toString());
                setResult(RESULT_OK, resultado);
                //finish();
                textoPregunta.setText("");
                butOp1.setText("");
            ...
            case R.id.butOpc4:
            {
                resultado.putExtra(RESPUESTA, butOp4.getText().toString());
                setResult(RESULT_OK, resultado);
                //finish();
                textoPregunta.setText("");
                butOp1.setText("");
